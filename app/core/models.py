...
class Server(models.Model):
    ...
    server_type = models.CharField(max_length=20, choices=choices.server_choices, default='unknown') # bad: reserved keyword    test_method = models.CharField(null=False, max_length=50, choices=choices.test_type_choices, default='0')
    lat = models.DecimalField(default=16.647322, max_digits=22, decimal_places=16, blank=True, null=True)
    long = models.FloatField(default=121.071959,  max_digits=22, decimal_places=16, blank=True, null=True)
    ...
    hostname = models.URLField(max_length=500, default="https://netmesh-web.asti.dost.gov.ph/")
...
class Test(models.Model):
    ...
    tester = models.ForeignKey(FieldTester, null=False, on_delete=models.CASCADE)
...
class Speedtest(models.Model):
    ...
    """
    date = models.DateTimeField(default=timezone.now)
    test_id = models.UUIDField(null=False, editable=True, unique=True)
